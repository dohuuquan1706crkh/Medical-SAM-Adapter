...
def parse_args():    
    ...
    parser.add_argument('-exp_name', default='msa_train_isic', type=str, help='net type')
    parser.add_argument('-type', type=str, default='map', help='condition type:ave,rand,rand_map')
    parser.add_argument('-vis', type=int, default=40, help='visualization')
    ...
    parser.add_argument('-loss', type=str, default="BCEWithLogitsLoss", help='loss') #evidential,  BCEWithLogitsLoss,  DiceCELoss
