...
def parse_args():
    ...
    parser.add_argument('-val_mode',type=str,default='entropy',help='Eval mode: entropy, mc_dropout, deep_ensemble, ttdap, ttdac')
    ...
    parser.add_argument('-loss', type=str, default="BCEWithLogitsLoss", help='loss')    #DiceCELoss, BCEWithLogitsLoss
    ...
    parser.add_argument('-two_round', type=bool, default=False , help='two_round or not')
    parser.add_argument(
    '-data_path',
    type=str,
    default='../data',
